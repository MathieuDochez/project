<x-project-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg shadow-xl mb-8 p-8 text-white">
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
                    <h3 class="text-2xl font-semibold text-gray-800 mb-6 border-b border-gray-200 pb-3">
                        <span class="text-orange-600">📍</span> Our Information
                    </h3>
                    ...
                    <div x-data="{ isOpen: false }" class="mt-8 pt-6 border-t border-gray-200">
                        <h4 @click="isOpen = !isOpen" class="text-xl font-semibold text-gray-800 mb-4 cursor-pointer flex items-center justify-between hover:text-orange-600 transition-colors">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
                    <h3 class="text-2xl font-semibold text-gray-800 mb-6 border-b border-gray-200 pb-3">
                        <span class="text-orange-600">✉️</span> Send us a Message
                    </h3>
            ...
            <div class="mt-8 bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
                <h3 class="text-2xl font-semibold text-gray-800 mb-6 border-b border-gray-200 pb-3">
                    <span class="text-orange-600">🗺️</span> Find Us Here
                </h3>
                <div class="relative overflow-hidden pb-[56.25%] mb-4 rounded-lg shadow-lg border-4 border-orange-100">
