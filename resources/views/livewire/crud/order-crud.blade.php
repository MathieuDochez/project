<div class="p-6 bg-gray-100 rounded-lg shadow-md">
    ...
    <!-- Pagination Controls -->
    <div class="mt-4">
        {{ $orders->links() }} <!-- This will render the pagination links -->
    </div>

    <!-- Create / Edit Form Section -->
    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}" class="space-y-6 bg-white p-6 rounded-lg shadow-md mt-8">
        <div>
        ...
        <div>
            ...
            <input type="number" id="total_price" wire:model="total_price" class="w-full mt-1 p-2 border border-gray-300 rounded focus:ring-blue-500 focus:border-blue-500" />
